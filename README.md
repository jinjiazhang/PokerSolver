...
- 📉 **可利用度计算** — Best Response 剩前度实时跟踪，迭代中每次输出收敛状态
...
### 多线程加速 (Turn, 20×29 范围, 50 iterations)
...
```
Starting DCFR solver (500 iterations, isomorphism)...
============================================================
  Iter    1 | 0.1 ms | avg 0.1 ms | ETA 0s | exploit 150.091%
  Iter   10 | 0.1 ms | avg 0.2 ms | ETA 0s | exploit 6.576%
  Iter   50 | 0.1 ms | avg 0.1 ms | ETA 0s | exploit -5.230%
  Iter  200 | 0.1 ms | avg 0.1 ms | ETA 0s | exploit -5.536%
  Iter  500 | 0.1 ms | avg 0.1 ms | ETA 0s | exploit -5.491%
============================================================
Solving complete in 0.06 seconds
```
